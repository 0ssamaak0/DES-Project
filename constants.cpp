int initial_prem[64] = {58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44,
...
int inv_initial_prem[64] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47,
...
int perm_1[64] = {57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34,
                  26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3,
                  60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7,
                  62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37,
                  29, 21, 13, 5, 28, 20, 12, 4};

int perm_2[48] = {14, 17, 11, 24, 1, 5, 3, 28,
...
int expansion[48] = {32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9,
                     8, 9, 10, 11, 12, 13, 12, 13, 14, 15, 16, 17,
                     16, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25,
                     24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1};

// 8 tables, 4 rows, 16 cols
int sbox[8][4][16] = {{14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5,
...
int shift_amt[16] = {1, 1, 2, 2, 2, 2, 2, 2,
                     1, 2, 2, 2, 2, 2, 2, 1};